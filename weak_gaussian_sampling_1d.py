...
if __name__ == '__main__':
    ...
    samples = 2000
    dataset = DataSet(t, true_dt=true_dt, samples_num=samples, dim=1, drift_term=drift, diffusion_term=diffusion,
    ...
    model.compile(basis_order=3, gauss_variance=1, type='LMM_2', drift_term=drift, diffusion_term=diffusion, gauss_samp_way='lhs', lhs_ratio=0.7)
    model.train(gauss_samp_number=20, lam=0.01, STRidge_threshold=0.1)
