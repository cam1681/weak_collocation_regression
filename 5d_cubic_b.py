...
if __name__ == '__main__':
    ...
    T, dt = 10, 0.0001
    # t = torch.tensor([0.1, 0.3, 0.5, 0.7, 1])
    ...
    drift = torch.tensor([0, 1, 0, -1]).repeat(5, 1)
    ...
    model.compile(basis_order=3, gauss_variance=0.75, type='non-equal-adams', drift_term=drift, diffusion_term=diffusion,
    ...
    model.train(gauss_samp_number=500, lam=0.0, STRidge_threshold=0.1, only_hat_13=False)
