...
if __name__ == '__main__':
    ...
    dataset = DataSet(t, true_dt=true_dt, samples_num=sample, dim=dim, drift_term=drift, diffusion_term=diffusion,
                      initialization=torch.normal(mean=0., std=0.1, size=(sample, 1)),   # torch.normal(mean=0., std=0.1, size=(sample, dim)),
                      drift_independence=True, explosion_prevention=False, trajectory_information=True)
    ...
    model.train(gauss_samp_number=10000, lam=0.0, STRidge_threshold=0.2, only_hat_13=False)


# Drift term:  [0.] + [1.1406049]x_1^1 + [0.]x_1^2 + [-1.1272535]x_1^3
# Drift term:  [0.] + [1.1799815]x_2^1 + [0.]x_2^2 + [-1.1858288]x_2^3
# Drift term:  [0.] + [1.1443274]x_3^1 + [0.]x_3^2 + [-1.1434461]x_3^3
# Drift term:  [0.] + [1.1663184]x_4^1 + [0.]x_4^2 + [-1.1481127]x_4^3
# Drift term:  [0.] + [1.158327]x_5^1 + [0.]x_5^2 + [-1.1439313]x_5^3
# Drift term:  [0.] + [1.1313057]x_6^1 + [0.]x_6^2 + [-1.1138384]x_6^3
# Drift term:  [0.] + [1.1187617]x_7^1 + [0.]x_7^2 + [-1.1212587]x_7^3
# Drift term:  [0.] + [1.0332153]x_8^1 + [0.]x_8^2 + [-1.0158637]x_8^3
# Drift term:  [0.] + [1.1641586]x_9^1 + [0.]x_9^2 + [-1.1447709]x_9^3
# Drift term:  [0.] + [1.124225]x_10^1 + [0.]x_10^2 + [-1.1114475]x_10^3
# Diffusion term:  diag  [1.0475377 1.0456035 1.0443636 1.0456716 1.0464231 1.0456889 1.0486287
#  1.0478461 1.0413601 1.0454507]
# Maximum relative error:  0.1858288
# Maximum index:  tensor(3)
# 'train' took 4152.503034 s